...
-- Task 1: same geometry and friction as bp3_d60_normal, but DOUBLE the plate
-- convergence rate (Vp: -1e-9 -> -2e-9 m/s). Faster tectonic loading is
-- expected to shorten the interseismic period and advance the first event.
bp3_d60_normal_2Vp = BP3.new{dip=60, Vp=-2e-9}